...
import DarkLightModeTogglerBtn from './ui/dark-light-toggle-btn'
      ...
      <div className="flex justify-around items-center h-20 bg-pink-500">
        ...
        <div className="routes">
          <ul className='flex gap-4 items-center '>
            <li><DarkLightModeTogglerBtn /></li>
            <li><Link className="" to={'/'}>Home</Link></li>
            <li>{isLoggedIn ?
              <button onClick={logout} className='bg-violet-500 p-4 rounded-3xl cursor-pointer'>Logout</button>
              :
              <div className='flex'>
