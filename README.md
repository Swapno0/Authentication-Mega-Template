This project is a continuation of my Mega-Backend-Template. This project is even better than that template. There were some problems in out Backend Template project, that has been solved here. Not only that, some more features are also added here. The frontend is minimalistic here because our main focus was backend functionalities. The following functionalities are present here ----
